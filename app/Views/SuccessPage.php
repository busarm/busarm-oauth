...
{
    public function __construct(protected SuccessPageDto|BaseDto|array|null $data = null, protected $headers = array())
    {
    }
            ...
            <oauth-success>
                <div class="success-page">
                    <div class="form">
                        ...
                        <br>
                        <h3> Authorization link Sent to <strong style="font-size: 16px"><?= $this->data->email ?></strong></h3>
                        <i><?= $this->data->msg ?? '' ?></i>
